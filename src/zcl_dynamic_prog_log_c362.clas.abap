CLASS zcl_dynamic_prog_log_c362 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_dynamic_prog_log_c362 IMPLEMENTATION.
...
**                   <gs_data>      TYPE any.
*
*    DATA: gt_employee TYPE STANDARD TABLE OF zemployee_c362.
**
...
**                                             currency_code = 'MXN' ) ).
**
**    MODIFY zemployee_c362 FROM TABLE @gt_employee.
*
*    DATA(gs_employee) = VALUE zemployee_c362(  mandt         = 100
*                                              id            = '10001'
*                                              first_name    = 'Laura'
*                                              last_name     = 'Martinez'
*                                              email         = 'lmartinez@logali.com'
...
*        IF <gs_employee> IS ASSIGNED.
*
*          <gs_employee>-email = |{ <gs_employee>-email }.mx.com|.
*
*        ENDIF.
*
*      ENDLOOP.
...
*    out->write( <fs_value> ).
*
*    DATA(lo_class) = NEW zcl_dynamic_prog_log_c362( ).
...
*
*    DATA lt_data TYPE TABLE OF zemployee_c362.
*    CREATE DATA lr_data02 LIKE lt_data.
*
*    CREATE DATA lr_data02 TYPE HASHED TABLE OF zemployee_c362 WITH UNIQUE KEY id.
*
*** Anonymous structures
*    CREATE DATA lr_data02 LIKE LINE OF lt_data.
*    CREATE DATA lr_data02 TYPE zemployee_c362.
*
*** New
*    DATA(lr_data03) = NEW i( 123 ).
*    DATA(lr_data04) = NEW zemployee_c362( id = 10005 first_name = 'Jose' ).
**
*** Select
*    SELECT FROM zemployee_c362
*           FIELDS *
...
*    out->write( lr_data05 ).
*
*    SELECT SINGLE * FROM zemployee_c362
