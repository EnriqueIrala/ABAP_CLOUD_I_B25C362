CLASS zcl_secondary_key_log_c362 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_secondary_key_log_c362 IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    DATA(lo_object) = NEW zcl_secondary_key_log_c362( ).
  ...
  METHOD read_non_key.
    ...
    DATA(ls_flight) = lt_sort[ flight_date = '20250315' ].
